...
# Load the results
results_path = 'output_data/20251227_205942_gemini-2.5-flash_yelp_retrieval_uncertainty_entropy_LLMprobe_contriever_s42_n5/retrieval_comparison_results.csv'
...
# Save to CSV
output_path = 'output_data/20251227_205942_gemini-2.5-flash_yelp_retrieval_uncertainty_entropy_LLMprobe_contriever_s42_n5/retrieval_comparison_pivot_accuracy.csv'
