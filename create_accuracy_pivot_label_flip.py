...
# Load the results for CF-Only (Label Flip) run
results_path = 'output_data/20251229_191054_gemini-2.5-flash_yelp_retrieval_random_random_contriever_s42_n5/retrieval_comparison_results.csv'
...
# Save to CSV
output_path = 'output_data/20251229_191054_gemini-2.5-flash_yelp_retrieval_random_random_contriever_s42_n5/retrieval_comparison_pivot_accuracy.csv'
